...
precession_matrix <- function(jd)
{
  ...
  prec_mat <- data.frame(matrix(0.0, nrow=3, ncol=3))
  
  v <- cross_product(equator_pole, ecliptic_pole)
  normal_vec <- unit_vector(v)
  a <- cross_product(equator_pole, normal_vec)
