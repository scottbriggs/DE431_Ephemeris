...
apparent_place_jupiter <- function(con, jd)
{
  ...
  jupiter_ssb <- position_jupiter_ssb(con, t)
  ...
  jupiter_ssb_au_day <- jupiter_ssb[,2] / KM2AU
  ...
  # Extract the barycentric position of Jupiter and the Sun at t - tau
  jupiter_ssb <- position_jupiter_ssb(con, tt)
  ...
  repeat {
    ...
    if ((tau - tau_prime) < 1E-9){
      ...
      jupiter_ssb <- position_jupiter_ssb(con, (t - tau_prime))
